...
export default function EditProject() {
  ...
  const [formData, setFormData] = useState({
    customer: 'Rushika Heer',
    referenceNumber: 'GA0606765263A20',
    projectName: 'Arti Beauty',
    projectNumber: '6958366516',
    areaLocation: 'Assam, West Bengal',
    address: '48, Vilas Nagar, Jahangirpur, Bangaluru, Karnataka, 450012',
    dueDate: '2024-02-05',
    contact: '8173410411',
    manager: 'Amar Panwar',
    staff: 'Risha Badarecha',
    status: 'In Progress',
            ...
            <div className="form-grid">
              <div className="form-group">
                ...
                <select
                  ...
                  required
                >
                  <option value="Rushika Heer">Rushika Heer</option>
              ...
              <div className="form-group">
                ...
                <select
                  ...
                  required
                >
                  <option value="Risha Badarecha">Risha Badarecha</option>

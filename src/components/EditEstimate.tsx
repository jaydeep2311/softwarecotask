...
export default function EditEstimate() {
  ...
  // Pre-filled data for the edit form (as shown in the image)
  const [sections, setSections] = useState<EstimateSection[]>([
    {
      id: '1',
      sectionName: 'Electric',
      items: [
        { id: '1-1', itemName: 'Lamps', description: 'Item Description', unit: 'QTY', quantity: 100, price: 120, margin: 0 },
        { id: '1-2', itemName: 'Wires', description: 'Item Description', unit: 'Meter', quantity: 20, price: 200, margin: 0 },
        { id: '1-3', itemName: 'Electric Tool', description: 'Item Description', unit: 'Box', quantity: 10, price: 2000, margin: 10 }
      ]
    },
    {
      id: '2',
      sectionName: 'Colors Tea',
      items: [
        { id: '2-1', itemName: 'Red Color', description: 'Item Description', unit: 'QTY', quantity: 12, price: 3000, margin: 5 },
        { id: '2-2', itemName: 'Blue Color', description: 'Item Description', unit: 'QTY', quantity: 10, price: 1500, margin: 5 },
        { id: '2-3', itemName: 'Yellow Color', description: 'Item Description', unit: 'QTY', quantity: 8, price: 1500, margin: 5 }
      ]
    }
  ]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Updating estimate:', sections);
    navigate('/estimates');
  };
    ...
    <div className="projects-layout">
      ...
      <main className="main-content">
        ...
        <div className="estimate-form-container">
          <h1 className="form-title">Edit Estimates</h1>
          ...
          <form onSubmit={handleSubmit} className="estimate-form">
              ...
              {sections.map((section, sectionIndex) => (
                <div key={section.id} className="estimate-section">
                  <div className="section-header">
                    ...
                    />
                    <div className="section-total">{calculateSectionTotal(section).toLocaleString('en-US', { minimumFractionDigits: 2 })}</div>
            ...
            <div className="estimate-totals">
              <div className="total-row">
                ...
                <span className="total-value">$ {totals.subTotal.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
              </div>
              <div className="total-row">
                <span className="total-label">Total Margin</span>
                <span className="total-value">$ {totals.totalMargin.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
              </div>
              <div className="total-row final-total">
                <span className="total-label">Total Amount</span>
                <span className="total-value">$ {totals.totalAmount.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
              </div>
            </div>
